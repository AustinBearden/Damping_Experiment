...
function calculateAll() {
    ...
    var ball = new CANNON.Body({
        ...
        velocity: new CANNON.Vec3(init_velocity, init_velocity, init_velocity) // velocity in m / s

    });

    ball.linearDamping = damping_val; // linear damping
    ...
    var initial_velocity = ball.velocity.x;
    console.log("BV: " + initial_velocity);

    world.step(1/5); // 0.5 seconds

    var current_velocity = ball.velocity.x;
